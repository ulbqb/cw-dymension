...
/// Convert a list of `Coin` from dymension proto generated proto `Coin` type to cosmwasm `Coin` type
...
/// Convert a list of `Coin` from cosmwasm `Coin` type to  dymension proto generated proto `Coin` type
...
/// dymension_std::cosmos::base::abci::v1beta1::Result conflicts core::result::Result
/// so it's defined manually.
...
#[derive(
    ...
    ::serde::Deserialize,
    ::schemars::JsonSchema,
    dymension_std_derive::CosmwasmExt,
)]
...
pub struct ABCIResult {
    ...
    #[serde(default)]
    pub events: ::prost::alloc::vec::Vec<crate::types::tendermint::abci::Event>,
