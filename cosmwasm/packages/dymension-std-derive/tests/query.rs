...
#[proto_message(type_url = "/dymension.tokenfactory.v1beta1.QueryDenomsFromCreatorRequest")]
#[proto_query(
    path = "/dymension.tokenfactory.v1beta1.Query/DenomsFromCreator",
...
#[proto_message(type_url = "/dymension.tokenfactory.v1beta1.QueryDenomsFromCreatorResponse")]
